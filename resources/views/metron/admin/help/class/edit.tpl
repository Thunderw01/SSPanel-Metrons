                    ...
                    <div class="card-main">
                        <div class="card-inner">
                            ...
                            <div class="form-group form-group-label">
                                ...
                                <input class="form-control maxwidth-edit" id="desc" name="desc" type="text" value="{$helpc->descs}">
                            </div>
                            <div class="form-group form-group-label">
                                    ...
                                    <div class="col-md-10 col-md-push-1">
                                        ...
                                        <div class="form-group form-group-label">
                                            <div class="checkbox switch">
                                                <label for="is_1ji">
                                                    <input class="access-hide" id="is_1ji" type="radio" {if $helpc->upid == 0}checked='checked'{/if} name="is_dji" value="1"><span class="switch-toggle"></span>设置为一级分类
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group form-group-label">
                                            <div class="checkbox switch">
                                                <label for="is_2ji">
                                                    <input class="access-hide" id="is_2ji" type="radio" {if $helpc->upid > 0}checked='checked'{/if} name="is_dji" value="2"><span class="switch-toggle"></span>设置为二级分类
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group form-group-label">
                                            <div class="checkbox switch">
                                                <label for="pageshow">
                                                    <input class="access-hide" id="pageshow" type="checkbox" {if $helpc->pageshow == 1}checked='checked'{/if} name="pageshow"><span class="switch-toggle"></span>页面是否显示该分类以及文档
                                                </label>
